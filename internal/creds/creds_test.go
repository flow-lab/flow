...
func TestCreds(t *testing.T) {
	...
	t.Run("Should generate Config and Credentials", func(t *testing.T) {
		config, credentials, err := GenerateConfigAndCredentials("A", "B", "eu-west-1")
	...
	t.Run("Should generate Credentials env for Intellij", func(t *testing.T) {
		env, err := GenerateEnv("eu-west-1", "a", "b", "c")
